const Footer = () => {
  return (
    <footer className=" border-t-4  w-full border-closet ">
      <div className="max-w-screen-xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-6 border-b">
          <div className="flex items-center gap-4">
            <h2 className="text-3xl font-bold text-shadow-closet">Krab Food</h2>
          </div>
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex gap-2">
              ...
              />
              <button className="bg-closet hover:bg-red-700 text-white px-6 py-2 rounded-full">
                ĐĂNG KÝ →
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-10">
          {/* Cột 1 */}
          <div>
            <h4 className="font-bold uppercase border-b-2 border-closet inline-block mb-2">
              VỀ CHÚNG TÔI
            </h4>
          ...
          <div>
            ...
            <ul className="text-sm space-y-2">
              <li>
                <i className="fas fa-map-marker-alt border-closet  mr-2"></i> Dịch
                Vọng Hậu - Cầu Giấy - Hà Nội
              </li>
              <li>
                <i className="fas fa-phone-alt border-closet  mr-2"></i> 0123 456
                789
              </li>
              <li>
                <i className="fas fa-envelope border-closet  mr-2"></i>{" "}
                abc@domain.com
              </li>
              <li>
                <i className="fas fa-envelope border-closet  mr-2"></i>{" "}
        ...
        <div className="text-center text-sm text-gray-500 mt-10">
          Copyright 2077 © Krab Food. All Rights Reserved.
        </div>
      </div>
    </footer>
  );
