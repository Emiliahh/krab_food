...
const AddModal = ({ open, onClose, categories }: EditProductDialogProps) => {
    ...
    const handleChange = (
        ...
        // handle number parsing for price
        if (name === "price") {
            setFormData((prev) => ({
                ...prev,
    ...
    const handleSubmit =  async (e: React.FormEvent) => {
        e.preventDefault();
        console.log("Thêm sản phẩm:", {...formData, image });
        const res = await addProduct(formData);
        if(res) {
            console.log("Thêm sản phẩm thành công:", res);
        }
        onClose(); // Đóng modal sau khi thêm sản phẩm thành công
        // Call API hoặc xử lý dữ liệu tại đây
    };
                ...
                <div className="flex flex-col md:flex-row gap-8 pt-4">
                    ...
                    <div className="flex flex-col items-center flex-1 gap-6">
                        <img
                            src={
                                formData.image ||
                                "https://cdn.pixabay.com/photo/2017/02/03/17/34/pug-2035675_640.jpg"
                            }
                            alt="preview"
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-full bg-red-700 hover:bg-red-800 text-white px-6 py-2 rounded flex items-center justify-center gap-2"
                        >
